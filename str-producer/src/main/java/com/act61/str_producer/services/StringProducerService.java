package com.act61.str_producer.services;
...
public class StringProducerService {
    ...
    public void sendMessage(String message){
        kafkaTemplate.send("str-topic", message).whenComplete((result, ex) -> {
            ...
            log.info("Partición: {}, Offset: {}", result.getRecordMetadata().partition(), result.getRecordMetadata().partition(), result.getRecordMetadata().offset());
        });
    }
}
